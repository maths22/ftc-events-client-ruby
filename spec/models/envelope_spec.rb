...
# Unit tests for FtcEventsClient::Envelope
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Envelope' do
  before do
    # run before each test
    @instance = FtcEventsClient::Envelope.new
  end
  ...
  describe 'test an instance of Envelope' do
    it 'should create an instance of Envelope' do
      expect(@instance).to be_instance_of(FtcEventsClient::Envelope)
    end
  end
  ...
  describe 'test attribute "min_extent"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "max_extent"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
