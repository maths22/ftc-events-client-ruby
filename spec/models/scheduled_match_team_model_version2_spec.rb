...
# Unit tests for FtcEventsClient::ScheduledMatchTeamModelVersion2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ScheduledMatchTeamModelVersion2' do
  before do
  ...
  describe 'test an instance of ScheduledMatchTeamModelVersion2' do
    it 'should create an instance of ScheduledMatchTeamModelVersion2' do
      expect(@instance).to be_instance_of(FtcEventsClient::ScheduledMatchTeamModelVersion2)
    end
  end
