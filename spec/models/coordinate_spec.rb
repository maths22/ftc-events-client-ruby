...
# Unit tests for FtcEventsClient::Coordinate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Coordinate' do
  before do
    # run before each test
    @instance = FtcEventsClient::Coordinate.new
  end
  ...
  describe 'test an instance of Coordinate' do
    it 'should create an instance of Coordinate' do
      expect(@instance).to be_instance_of(FtcEventsClient::Coordinate)
    end
  end
  ...
  describe 'test attribute "coordinate_value"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
