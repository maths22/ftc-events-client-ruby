...
# Unit tests for FtcEventsClient::SeasonSummaryModelVersion2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FtcEventsClient::SeasonSummaryModelVersion2 do
  let(:instance) { FtcEventsClient::SeasonSummaryModelVersion2.new }

  describe 'test an instance of SeasonSummaryModelVersion2' do
    it 'should create an instance of SeasonSummaryModelVersion2' do
      expect(instance).to be_instance_of(FtcEventsClient::SeasonSummaryModelVersion2)
    end
  end
  ...
  describe 'test attribute "game_name"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "kickoff"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "rookie_start"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "frc_championships"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
