...
# Unit tests for FtcEventsClient::ScoreDetailModel2021
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ScoreDetailModel2021' do
  before do
    # run before each test
    @instance = FtcEventsClient::ScoreDetailModel2021.new
  end
  ...
  describe 'test an instance of ScoreDetailModel2021' do
    it 'should create an instance of ScoreDetailModel2021' do
      expect(@instance).to be_instance_of(FtcEventsClient::ScoreDetailModel2021)
    end
  end
