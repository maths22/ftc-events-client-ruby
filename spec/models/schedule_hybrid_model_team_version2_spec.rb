...
# Unit tests for FtcEventsClient::ScheduleHybridModelTeamVersion2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FtcEventsClient::ScheduleHybridModelTeamVersion2 do
  let(:instance) { FtcEventsClient::ScheduleHybridModelTeamVersion2.new }

  describe 'test an instance of ScheduleHybridModelTeamVersion2' do
    it 'should create an instance of ScheduleHybridModelTeamVersion2' do
      expect(instance).to be_instance_of(FtcEventsClient::ScheduleHybridModelTeamVersion2)
    end
  end
  ...
  describe 'test attribute "no_show"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
