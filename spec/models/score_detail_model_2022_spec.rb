...
# Unit tests for FtcEventsClient::ScoreDetailModel2022
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ScoreDetailModel2022' do
  before do
    # run before each test
    @instance = FtcEventsClient::ScoreDetailModel2022.new
  end
  ...
  describe 'test an instance of ScoreDetailModel2022' do
    it 'should create an instance of ScoreDetailModel2022' do
      expect(@instance).to be_instance_of(FtcEventsClient::ScoreDetailModel2022)
    end
  end
  ...
  describe 'test attribute "match_series"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
