...
# Unit tests for FtcEventsClient::ScoreDetailModelSinglePlayer2022
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ScoreDetailModelSinglePlayer2022' do
  before do
    # run before each test
    @instance = FtcEventsClient::ScoreDetailModelSinglePlayer2022.new
  end
  ...
  describe 'test an instance of ScoreDetailModelSinglePlayer2022' do
    it 'should create an instance of ScoreDetailModelSinglePlayer2022' do
      expect(@instance).to be_instance_of(FtcEventsClient::ScoreDetailModelSinglePlayer2022)
    end
  end
  ...
  describe 'test attribute "randomization"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
