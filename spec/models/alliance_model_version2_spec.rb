...
# Unit tests for FtcEventsClient::AllianceModelVersion2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FtcEventsClient::AllianceModelVersion2 do
  let(:instance) { FtcEventsClient::AllianceModelVersion2.new }

  describe 'test an instance of AllianceModelVersion2' do
    it 'should create an instance of AllianceModelVersion2' do
      expect(instance).to be_instance_of(FtcEventsClient::AllianceModelVersion2)
    end
  end
  ...
  describe 'test attribute "captain"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "round1"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "round2"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "round3"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "backup_replaced"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
