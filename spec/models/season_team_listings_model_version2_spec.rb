...
# Unit tests for FtcEventsClient::SeasonTeamListingsModelVersion2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FtcEventsClient::SeasonTeamListingsModelVersion2 do
  let(:instance) { FtcEventsClient::SeasonTeamListingsModelVersion2.new }

  describe 'test an instance of SeasonTeamListingsModelVersion2' do
    it 'should create an instance of SeasonTeamListingsModelVersion2' do
      expect(instance).to be_instance_of(FtcEventsClient::SeasonTeamListingsModelVersion2)
    end
  end
  ...
  describe 'test attribute "team_count_total"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "team_count_page"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "page_current"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
