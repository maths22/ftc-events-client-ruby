...
# Unit tests for FtcEventsClient::NtsGeometryServices
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NtsGeometryServices' do
  before do
    # run before each test
    @instance = FtcEventsClient::NtsGeometryServices.new
  end
  ...
  describe 'test an instance of NtsGeometryServices' do
    it 'should create an instance of NtsGeometryServices' do
      expect(@instance).to be_instance_of(FtcEventsClient::NtsGeometryServices)
    end
  end
  describe 'test attribute "geometry_overlay"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "coordinate_equality_comparer"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "default_srid"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "default_coordinate_sequence_factory"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "default_precision_model"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
