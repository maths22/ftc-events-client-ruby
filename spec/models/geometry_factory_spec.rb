...
# Unit tests for FtcEventsClient::GeometryFactory
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GeometryFactory' do
  before do
    # run before each test
    @instance = FtcEventsClient::GeometryFactory.new
  end
  ...
  describe 'test an instance of GeometryFactory' do
    it 'should create an instance of GeometryFactory' do
      expect(@instance).to be_instance_of(FtcEventsClient::GeometryFactory)
    end
  end
  ...
  describe 'test attribute "coordinate_sequence_factory"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "geometry_services"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
