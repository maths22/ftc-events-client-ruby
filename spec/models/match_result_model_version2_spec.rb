...
# Unit tests for FtcEventsClient::MatchResultModelVersion2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FtcEventsClient::MatchResultModelVersion2 do
  let(:instance) { FtcEventsClient::MatchResultModelVersion2.new }

  describe 'test an instance of MatchResultModelVersion2' do
    it 'should create an instance of MatchResultModelVersion2' do
      expect(instance).to be_instance_of(FtcEventsClient::MatchResultModelVersion2)
    end
  end
