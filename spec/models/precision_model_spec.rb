...
# Unit tests for FtcEventsClient::PrecisionModel
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PrecisionModel' do
  before do
    # run before each test
    @instance = FtcEventsClient::PrecisionModel.new
  end
  ...
  describe 'test an instance of PrecisionModel' do
    it 'should create an instance of PrecisionModel' do
      expect(@instance).to be_instance_of(FtcEventsClient::PrecisionModel)
    end
  end
  describe 'test attribute "is_floating"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "maximum_significant_digits"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "grid_size"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "precision_model_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
