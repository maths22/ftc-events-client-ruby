...
# Unit tests for FtcEventsClient::AdvancementSlot
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AdvancementSlot' do
  before do
    # run before each test
    @instance = FtcEventsClient::AdvancementSlot.new
  end
  ...
  describe 'test an instance of AdvancementSlot' do
    it 'should create an instance of AdvancementSlot' do
      expect(@instance).to be_instance_of(FtcEventsClient::AdvancementSlot)
    end
  end
  ...
  describe 'test attribute "team_profile_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "display_team"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
