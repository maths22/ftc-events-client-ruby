...
# Unit tests for FtcEventsClient::CoordinateSequence
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CoordinateSequence' do
  before do
    # run before each test
    @instance = FtcEventsClient::CoordinateSequence.new
  end
  ...
  describe 'test an instance of CoordinateSequence' do
    it 'should create an instance of CoordinateSequence' do
      expect(@instance).to be_instance_of(FtcEventsClient::CoordinateSequence)
    end
  end
  ...
  describe 'test attribute "ordinates"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "has_z"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "has_m"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "z_ordinate_index"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "m_ordinate_index"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
