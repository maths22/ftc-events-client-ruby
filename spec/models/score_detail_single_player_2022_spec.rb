...
# Unit tests for FtcEventsClient::ScoreDetailSinglePlayer2022
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ScoreDetailSinglePlayer2022' do
  before do
    # run before each test
    @instance = FtcEventsClient::ScoreDetailSinglePlayer2022.new
  end
  ...
  describe 'test an instance of ScoreDetailSinglePlayer2022' do
    it 'should create an instance of ScoreDetailSinglePlayer2022' do
      expect(@instance).to be_instance_of(FtcEventsClient::ScoreDetailSinglePlayer2022)
    end
  end
  describe 'test attribute "init_signal_sleeve"' do
    it 'should work' do
  ...
  describe 'test attribute "dc_terminal"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "eg_navigated"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
