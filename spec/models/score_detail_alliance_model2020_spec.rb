...
# Unit tests for FtcEventsClient::ScoreDetailAllianceModel2020
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FtcEventsClient::ScoreDetailAllianceModel2020 do
  let(:instance) { FtcEventsClient::ScoreDetailAllianceModel2020.new }

  describe 'test an instance of ScoreDetailAllianceModel2020' do
    it 'should create an instance of ScoreDetailAllianceModel2020' do
      expect(instance).to be_instance_of(FtcEventsClient::ScoreDetailAllianceModel2020)
    end
  end
