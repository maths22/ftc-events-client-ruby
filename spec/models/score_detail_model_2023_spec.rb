...
# Unit tests for FtcEventsClient::ScoreDetailModel2023
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ScoreDetailModel2023' do
  before do
    # run before each test
    @instance = FtcEventsClient::ScoreDetailModel2023.new
  end
  ...
  describe 'test an instance of ScoreDetailModel2023' do
    it 'should create an instance of ScoreDetailModel2023' do
      expect(@instance).to be_instance_of(FtcEventsClient::ScoreDetailModel2023)
    end
  end
