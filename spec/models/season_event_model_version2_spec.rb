...
# Unit tests for FtcEventsClient::SeasonEventModelVersion2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FtcEventsClient::SeasonEventModelVersion2 do
  let(:instance) { FtcEventsClient::SeasonEventModelVersion2.new }

  describe 'test an instance of SeasonEventModelVersion2' do
    it 'should create an instance of SeasonEventModelVersion2' do
      expect(instance).to be_instance_of(FtcEventsClient::SeasonEventModelVersion2)
    end
  end
  ...
  describe 'test attribute "division_code"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "district_code"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "stateprov"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
