...
# Unit tests for FtcEventsClient::AdvancementSourceModel
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AdvancementSourceModel' do
  before do
    # run before each test
    @instance = FtcEventsClient::AdvancementSourceModel.new
  end
  ...
  describe 'test an instance of AdvancementSourceModel' do
    it 'should create an instance of AdvancementSourceModel' do
      expect(@instance).to be_instance_of(FtcEventsClient::AdvancementSourceModel)
    end
  end
  describe 'test attribute "advanced_from"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "advanced_from_region"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "advancement"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
