...
# Unit tests for FtcEventsClient::SeasonLeagueModelVersion2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FtcEventsClient::SeasonLeagueModelVersion2 do
  let(:instance) { FtcEventsClient::SeasonLeagueModelVersion2.new }

  describe 'test an instance of SeasonLeagueModelVersion2' do
    it 'should create an instance of SeasonLeagueModelVersion2' do
      expect(instance).to be_instance_of(FtcEventsClient::SeasonLeagueModelVersion2)
    end
  end
  ...
  describe 'test attribute "parent_league_code"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
