...
# Unit tests for FtcEventsClient::SeasonAwardsModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SeasonAwardsModel' do
  before do
  ...
  describe 'test an instance of SeasonAwardsModel' do
    it 'should create an instance of SeasonAwardsModel' do
      expect(@instance).to be_instance_of(FtcEventsClient::SeasonAwardsModel)
    end
  end
  ...
  describe 'test attribute "for_person"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
