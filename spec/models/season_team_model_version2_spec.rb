...
# Unit tests for FtcEventsClient::SeasonTeamModelVersion2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FtcEventsClient::SeasonTeamModelVersion2 do
  let(:instance) { FtcEventsClient::SeasonTeamModelVersion2.new }

  describe 'test an instance of SeasonTeamModelVersion2' do
    it 'should create an instance of SeasonTeamModelVersion2' do
      expect(instance).to be_instance_of(FtcEventsClient::SeasonTeamModelVersion2)
    end
  end
  ...
  describe 'test attribute "home_cmp"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
