...
# Unit tests for FtcEventsClient::ScoreDetailSinglePlayer2023
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ScoreDetailSinglePlayer2023' do
  before do
    # run before each test
    @instance = FtcEventsClient::ScoreDetailSinglePlayer2023.new
  end
  ...
  describe 'test an instance of ScoreDetailSinglePlayer2023' do
    it 'should create an instance of ScoreDetailSinglePlayer2023' do
      expect(@instance).to be_instance_of(FtcEventsClient::ScoreDetailSinglePlayer2023)
    end
  end
  describe 'test attribute "init_team_prop"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "robot_auto"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "spike_mark_pixel"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "target_backdrop_pixel"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "eg_robot"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "drone"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
