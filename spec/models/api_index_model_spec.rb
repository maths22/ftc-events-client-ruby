...
# Unit tests for FtcEventsClient::ApiIndexModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FtcEventsClient::ApiIndexModel do
  let(:instance) { FtcEventsClient::ApiIndexModel.new }

  describe 'test an instance of ApiIndexModel' do
    it 'should create an instance of ApiIndexModel' do
      expect(instance).to be_instance_of(FtcEventsClient::ApiIndexModel)
    end
  end
  ...
  describe 'test attribute "service_mainifest_name"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "service_mainifest_version"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "code_package_name"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "code_package_version"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
