...
# Unit tests for FtcEventsClient::AwardAssignmentModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FtcEventsClient::AwardAssignmentModel do
  let(:instance) { FtcEventsClient::AwardAssignmentModel.new }

  describe 'test an instance of AwardAssignmentModel' do
    it 'should create an instance of AwardAssignmentModel' do
      expect(instance).to be_instance_of(FtcEventsClient::AwardAssignmentModel)
    end
  end
  describe 'test attribute "award_id"' do
    it 'should work' do
  ...
  describe 'test attribute "event_division_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "full_team_name"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
