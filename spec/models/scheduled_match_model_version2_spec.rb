...
# Unit tests for FtcEventsClient::ScheduledMatchModelVersion2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FtcEventsClient::ScheduledMatchModelVersion2 do
  let(:instance) { FtcEventsClient::ScheduledMatchModelVersion2.new }

  describe 'test an instance of ScheduledMatchModelVersion2' do
    it 'should create an instance of ScheduledMatchModelVersion2' do
      expect(instance).to be_instance_of(FtcEventsClient::ScheduledMatchModelVersion2)
    end
  end
