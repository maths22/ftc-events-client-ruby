...
# Unit tests for FtcEventsClient::MatchResultsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'MatchResultsApi' do
  before do
  ...
  describe 'test an instance of MatchResultsApi' do
    it 'should create an instance of MatchResultsApi' do
      expect(@api_instance).to be_instance_of(FtcEventsClient::MatchResultsApi)
    end
  end

  # unit tests for v20_season_matches_event_code_get
  # Event Match Results
  ...
  # @param season Numeric year of the event from which the match results are requested. Must be 4 digits.
  # @param event_code Case insensitive alphanumeric &#x60;eventCode&#x60; of the event from which the results are requested. Must be at least 3 characters.
  ...
  describe 'v20_season_matches_event_code_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v20_season_scores_event_code_tournament_level_get
  # Score Details
  ...
  # @param season Numeric year of the event from which the match results are requested. Must be 4 digits.
  # @param event_code Case insensitive alphanumeric eventCode of the event from which the details are requested. Must be at least 3 characters.
  ...
  describe 'v20_season_scores_event_code_tournament_level_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
