...
# Unit tests for FtcEventsClient::AdvancementApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AdvancementApi' do
  before do
    # run before each test
    @instance = FtcEventsClient::AdvancementApi.new
  end
  ...
  describe 'test an instance of AdvancementApi' do
    it 'should create an instance of AdvancementApi' do
      expect(@instance).to be_instance_of(FtcEventsClient::AdvancementApi)
    end
  end

  # unit tests for v20_season_advancement_event_code_get
  # Event Advancement
  ...
  describe 'v20_season_advancement_event_code_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v20_season_advancement_event_code_source_get
  # Advancement Source
  ...
  describe 'v20_season_advancement_event_code_source_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
