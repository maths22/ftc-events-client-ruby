...
# Unit tests for FtcEventsClient::SeasonDataApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SeasonDataApi' do
  before do
  ...
  describe 'test an instance of SeasonDataApi' do
    it 'should create an instance of SeasonDataApi' do
      expect(@api_instance).to be_instance_of(FtcEventsClient::SeasonDataApi)
    end
  end

  # unit tests for v20_season_events_get
  # Event Listings
  ...
  # @param season Numeric year from which the event listings are requested. Must be 4 digits
  ...
  describe 'v20_season_events_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v20_season_get
  # Season Summary
  # The season summary API returns a high level glance of a particular FTC season.
  # @param season Numeric year of the event from which the season summary is requested. Must be 4 digits.
  # @param [Hash] opts the optional parameters
  # @return [SeasonSummaryModelVersion2]
  describe 'v20_season_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v20_season_teams_get
  # Team Listings
  ...
  # @param season Numeric year from which the team listings are requested. Must be 4 digits.
  # @param [Hash] opts the optional parameters
  ...
  describe 'v20_season_teams_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
