...
# Unit tests for FtcEventsClient::ScheduleApi
...
describe 'ScheduleApi' do
  ...
  describe 'test an instance of ScheduleApi' do
    it 'should create an instance of ScheduleApi' do
      expect(@api_instance).to be_instance_of(FtcEventsClient::ScheduleApi)
    end
  end

  # unit tests for v20_season_schedule_event_code_get
  # Event Schedule
  ...
  describe 'v20_season_schedule_event_code_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v20_season_schedule_event_code_tournament_level_hybrid_get
  # Hybrid Schedule
  ...
  describe 'v20_season_schedule_event_code_tournament_level_hybrid_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
