...
# Common files
require 'ftc_events_client/api_client'
require 'ftc_events_client/api_error'
require 'ftc_events_client/version'
require 'ftc_events_client/configuration'

# Models
require 'ftc_events_client/models/advancement_model'
require 'ftc_events_client/models/advancement_slot'
require 'ftc_events_client/models/advancement_source_model'
require 'ftc_events_client/models/alliance_model_version2'
require 'ftc_events_client/models/alliance_score_2020'
require 'ftc_events_client/models/alliance_selection_detail_model'
require 'ftc_events_client/models/alliance_selection_model_version2'
require 'ftc_events_client/models/api_advancement_status'
require 'ftc_events_client/models/api_index_model'
require 'ftc_events_client/models/auto_navigated_status'
require 'ftc_events_client/models/auto_navigation'
...
require 'ftc_events_client/models/coordinate'
require 'ftc_events_client/models/coordinate_equality_comparer'
require 'ftc_events_client/models/coordinate_sequence'
require 'ftc_events_client/models/coordinate_sequence_factory'
require 'ftc_events_client/models/dimension'
require 'ftc_events_client/models/end_game_location'
require 'ftc_events_client/models/endgame_parked_status'
require 'ftc_events_client/models/envelope'
...
require 'ftc_events_client/models/field_side'
require 'ftc_events_client/models/geometry'
require 'ftc_events_client/models/geometry_factory'
require 'ftc_events_client/models/geometry_overlay'
require 'ftc_events_client/models/junction_element'
...
require 'ftc_events_client/models/nts_geometry_services'
require 'ftc_events_client/models/ogc_geometry_type'
require 'ftc_events_client/models/one_of_match_scores_model_match_scores_items'
require 'ftc_events_client/models/ordinates'
require 'ftc_events_client/models/point'
require 'ftc_events_client/models/precision_model'
require 'ftc_events_client/models/precision_models'
...
require 'ftc_events_client/models/score_detail_alliance_model_2022'
require 'ftc_events_client/models/score_detail_alliance_model_2023'
...
require 'ftc_events_client/models/score_detail_model_2022'
require 'ftc_events_client/models/score_detail_model_2023'
...
require 'ftc_events_client/models/score_detail_model_single_player_2022'
require 'ftc_events_client/models/score_detail_model_single_player_2023'
require 'ftc_events_client/models/score_detail_single_player_2021'
require 'ftc_events_client/models/score_detail_single_player_2022'
require 'ftc_events_client/models/score_detail_single_player_2023'
...
require 'ftc_events_client/models/selection_model'
require 'ftc_events_client/models/selection_result'
require 'ftc_events_client/models/stone'
require 'ftc_events_client/models/team_ranking_model'

# APIs
require 'ftc_events_client/api/advancement_api'
...
require 'ftc_events_client/api/season_data_api'
