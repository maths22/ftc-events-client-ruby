...
module FtcEventsClient
  class ScheduleHybridModelVersion2
    attr_accessor :description

    attr_accessor :tournament_level
    ...
    attr_accessor :score_red_final

    attr_accessor :score_red_foul

    attr_accessor :score_red_auto

    attr_accessor :score_blue_final

    attr_accessor :score_blue_foul

    attr_accessor :score_blue_auto

    attr_accessor :score_blue_drive_controlled

    attr_accessor :score_blue_endgame

    attr_accessor :red_wins

    attr_accessor :blue_wins
    ...
    def self.attribute_map
      {
        ...
        :'score_red_final' => :'scoreRedFinal',
        :'score_red_foul' => :'scoreRedFoul',
        :'score_red_auto' => :'scoreRedAuto',
        :'score_blue_final' => :'scoreBlueFinal',
        :'score_blue_foul' => :'scoreBlueFoul',
        :'score_blue_auto' => :'scoreBlueAuto',
        :'score_blue_drive_controlled' => :'scoreBlueDriveControlled',
        :'score_blue_endgame' => :'scoreBlueEndgame',
        :'red_wins' => :'redWins',
        :'blue_wins' => :'blueWins',
        :'teams' => :'teams'
      }
    ...
    def self.openapi_types
      {
        ...
        :'post_result_time' => :'Object',
        :'score_red_final' => :'Object',
        :'score_red_foul' => :'Object',
        :'score_red_auto' => :'Object',
        :'score_blue_final' => :'Object',
        :'score_blue_foul' => :'Object',
        :'score_blue_auto' => :'Object',
        :'score_blue_drive_controlled' => :'Object',
        :'score_blue_endgame' => :'Object',
        :'red_wins' => :'Object',
        :'blue_wins' => :'Object',
        :'teams' => :'Object'
      }
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `FtcEventsClient::ScheduleHybridModelVersion2` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FtcEventsClient::ScheduleHybridModelVersion2`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'actual_start_time')
        self.actual_start_time = attributes[:'actual_start_time']
      end
      ...
      if attributes.key?(:'score_red_final')
        self.score_red_final = attributes[:'score_red_final']
      end

      if attributes.key?(:'score_red_foul')
        self.score_red_foul = attributes[:'score_red_foul']
      end

      if attributes.key?(:'score_red_auto')
        self.score_red_auto = attributes[:'score_red_auto']
      end

      if attributes.key?(:'score_blue_final')
        self.score_blue_final = attributes[:'score_blue_final']
      end

      if attributes.key?(:'score_blue_foul')
        self.score_blue_foul = attributes[:'score_blue_foul']
      end

      if attributes.key?(:'score_blue_auto')
        self.score_blue_auto = attributes[:'score_blue_auto']
      end

      if attributes.key?(:'score_blue_drive_controlled')
        self.score_blue_drive_controlled = attributes[:'score_blue_drive_controlled']
      end

      if attributes.key?(:'score_blue_endgame')
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          score_red_final == o.score_red_final &&
          score_red_foul == o.score_red_foul &&
          score_red_auto == o.score_red_auto &&
          score_blue_final == o.score_blue_final &&
          score_blue_foul == o.score_blue_foul &&
