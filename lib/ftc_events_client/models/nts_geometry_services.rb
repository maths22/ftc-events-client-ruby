...
module FtcEventsClient
  class NtsGeometryServices
    attr_accessor :geometry_overlay

    attr_accessor :coordinate_equality_comparer

    attr_accessor :default_srid

    attr_accessor :default_coordinate_sequence_factory

    attr_accessor :default_precision_model
    ...
    def self.openapi_types
      {
        ...
        :'default_srid' => :'Object',
        :'default_coordinate_sequence_factory' => :'Object',
        :'default_precision_model' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `FtcEventsClient::NtsGeometryServices` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FtcEventsClient::NtsGeometryServices`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'geometry_overlay')
        self.geometry_overlay = attributes[:'geometry_overlay']
      end

      if attributes.key?(:'coordinate_equality_comparer')
        self.coordinate_equality_comparer = attributes[:'coordinate_equality_comparer']
      end

      if attributes.key?(:'default_srid')
        self.default_srid = attributes[:'default_srid']
      end

      if attributes.key?(:'default_coordinate_sequence_factory')
        self.default_coordinate_sequence_factory = attributes[:'default_coordinate_sequence_factory']
      end

      if attributes.key?(:'default_precision_model')
        self.default_precision_model = attributes[:'default_precision_model']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          geometry_overlay == o.geometry_overlay &&
          coordinate_equality_comparer == o.coordinate_equality_comparer &&
          default_srid == o.default_srid &&
          default_coordinate_sequence_factory == o.default_coordinate_sequence_factory &&
          default_precision_model == o.default_precision_model
    end
    ...
    def hash
      [geometry_overlay, coordinate_equality_comparer, default_srid, default_coordinate_sequence_factory, default_precision_model].hash
    end
