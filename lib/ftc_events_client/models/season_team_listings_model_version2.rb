...
module FtcEventsClient
  class SeasonTeamListingsModelVersion2
    attr_accessor :teams

    attr_accessor :team_count_total

    attr_accessor :team_count_page

    attr_accessor :page_current
    ...
    def self.attribute_map
      {
        :'teams' => :'teams',
        :'team_count_total' => :'teamCountTotal',
        :'team_count_page' => :'teamCountPage',
    ...
    def self.openapi_types
      {
        :'teams' => :'Object',
        :'team_count_total' => :'Object',
        :'team_count_page' => :'Object',
        :'page_current' => :'Object',
        :'page_total' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `FtcEventsClient::SeasonTeamListingsModelVersion2` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FtcEventsClient::SeasonTeamListingsModelVersion2`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'team_count_total')
        self.team_count_total = attributes[:'team_count_total']
      end

      if attributes.key?(:'team_count_page')
        self.team_count_page = attributes[:'team_count_page']
      end

      if attributes.key?(:'page_current')
        self.page_current = attributes[:'page_current']
      end

      if attributes.key?(:'page_total')
    ...
    def ==(o)
      ...
      self.class == o.class &&
          teams == o.teams &&
          team_count_total == o.team_count_total &&
          team_count_page == o.team_count_page &&
          page_current == o.page_current &&
    ...
    def hash
      [teams, team_count_total, team_count_page, page_current, page_total].hash
    end
