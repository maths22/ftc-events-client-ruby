...
module FtcEventsClient
  class ApiIndexModel
    ...
    attr_accessor :service_mainifest_name

    attr_accessor :service_mainifest_version

    attr_accessor :code_package_name

    attr_accessor :code_package_version
    ...
    def self.openapi_types
      {
        :'name' => :'String',
        :'api_version' => :'String',
        :'service_mainifest_name' => :'String',
        :'service_mainifest_version' => :'String',
        :'code_package_name' => :'String',
        :'code_package_version' => :'String',
        :'status' => :'String',
