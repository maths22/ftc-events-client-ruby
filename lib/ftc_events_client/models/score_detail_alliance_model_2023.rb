...
module FtcEventsClient
  class ScoreDetailAllianceModel2023
    attr_accessor :init_team_prop1

    attr_accessor :init_team_prop2

    attr_accessor :robot1_auto

    attr_accessor :robot2_auto

    attr_accessor :spike_mark_pixel1

    attr_accessor :spike_mark_pixel2

    attr_accessor :target_backdrop_pixel1

    attr_accessor :target_backdrop_pixel2
    ...
    attr_accessor :eg_robot1

    attr_accessor :eg_robot2

    attr_accessor :drone1

    attr_accessor :drone2
