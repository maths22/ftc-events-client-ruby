...
module FtcEventsClient
  class SeasonEventModelVersion2
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'live_stream_url')
        self.live_stream_url = attributes[:'live_stream_url']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          country == o.country &&
          website == o.website &&
          live_stream_url == o.live_stream_url &&
    ...
    def hash
      [event_id, code, division_code, name, remote, hybrid, field_count, published, type, type_name, region_code, league_code, district_code, venue, address, city, stateprov, country, website, live_stream_url, coordinates, webcasts, timezone, date_start, date_end].hash
    end
