...
module FtcEventsClient
  class SeasonSummaryModelVersion2
    ...
    attr_accessor :rookie_start

    attr_accessor :team_count

    attr_accessor :frc_championships
    ...
    def self.attribute_map
      {
        ...
        :'game_name' => :'gameName',
        :'kickoff' => :'kickoff',
        :'rookie_start' => :'rookieStart',
        :'team_count' => :'teamCount',
        :'frc_championships' => :'frcChampionships'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'game_name' => :'String',
        :'kickoff' => :'DateTime',
        :'rookie_start' => :'Integer',
        :'team_count' => :'Integer',
        :'frc_championships' => :'Array<SeasonSummaryModelChampionship>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `FtcEventsClient::SeasonSummaryModelVersion2` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FtcEventsClient::SeasonSummaryModelVersion2`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'game_name')
        self.game_name = attributes[:'game_name']
      end

      if attributes.key?(:'kickoff')
        self.kickoff = attributes[:'kickoff']
      end

      if attributes.key?(:'rookie_start')
        self.rookie_start = attributes[:'rookie_start']
      end
      ...
      if attributes.key?(:'frc_championships')
        if (value = attributes[:'frc_championships']).is_a?(Array)
          self.frc_championships = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          kickoff == o.kickoff &&
          rookie_start == o.rookie_start &&
          team_count == o.team_count &&
          frc_championships == o.frc_championships
    end
    ...
    def hash
      [event_count, game_name, kickoff, rookie_start, team_count, frc_championships].hash
    end
