  ...
  class Coordinate
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `FtcEventsClient::Coordinate` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FtcEventsClient::Coordinate`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'coordinate_value')
        self.coordinate_value = attributes[:'coordinate_value']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          z == o.z &&
          m == o.m &&
          coordinate_value == o.coordinate_value &&
          is_valid == o.is_valid
    end
    ...
    def hash
      [x, y, z, m, coordinate_value, is_valid].hash
    end
