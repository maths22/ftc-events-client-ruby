...
module FtcEventsClient
  class AwardAssignmentModel
    ...
    attr_accessor :event_division_id
    ...
    def self.openapi_types
      {
        ...
        :'event_id' => :'Object',
        :'event_division_id' => :'Object',
        :'event_code' => :'Object',
        :'name' => :'Object',
        :'series' => :'Object',
        :'team_number' => :'Object',
        :'school_name' => :'Object',
        :'full_team_name' => :'Object',
        :'person' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `FtcEventsClient::AwardAssignmentModel` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FtcEventsClient::AwardAssignmentModel`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'award_id')
      ...
      if attributes.key?(:'event_division_id')
        self.event_division_id = attributes[:'event_division_id']
      end
      ...
      if attributes.key?(:'full_team_name')
        self.full_team_name = attributes[:'full_team_name']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          event_id == o.event_id &&
          event_division_id == o.event_division_id &&
          event_code == o.event_code &&
          name == o.name &&
          series == o.series &&
          team_number == o.team_number &&
          school_name == o.school_name &&
          full_team_name == o.full_team_name &&
          person == o.person
    end
    ...
    def hash
      [award_id, team_id, team_profile_id, event_id, event_division_id, event_code, name, series, team_number, school_name, full_team_name, person].hash
    end
